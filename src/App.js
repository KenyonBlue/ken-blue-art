...
function App() {
  return (
    <div className="h-screen w-screen bg-BACKGROUND flex flex-col items-center justify-start">
      ...
      <div className="w-full bg-WHITE flex justify-center border-RED items-center">
      <div className="w-full px-20 max-container-width flex justify-between items-center py-2">
      ...
      <div className="w-full h-60 flex bg-WHITE flex justify-center absolute banner-top shadow-lg shadow-ORANGE">
        <div className="max-container-width flex w-full border-RED" >
